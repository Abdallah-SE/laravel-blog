      ...
      <div class="container text-center">
        ...
        <div class="row h-100">
          <div class="col-lg-8 mx-auto align-self-center">
            ...
            <p><img class="avatar avatar-sm" src="{{ Gravatar::get($post->user->email, ['size'=> 40]) }}" alt="..."></p>
...
@section('content')
    ...
    |‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒
    !-->
    <div class="row p-lg-9">
    {!! $post->content !!}
    </div>
    <div class="m-10" style="">
    ...
    |‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒
    !-->
    <div class="section bg-gray" style="height: 50px;">
      <div class="container">
          ...
          <div class="col-lg-8 mx-auto">
            <script>
                ...
                *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables    */
                ...
                s.src = 'https://sass-blog-46hkpawscj.disqus.com/embed.js';
